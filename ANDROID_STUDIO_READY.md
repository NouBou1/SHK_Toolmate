...
```
✅ StatusBar: overlaysWebView=false, color=#0a0a0a
✅ NavigationBar: color=#0a0a0a
📱 Body padding applied: top=25px, bottom=...px
🗂️ Nav height adjusted: ...px
🎯 Android Safe Area Berechnung: {...}
```
