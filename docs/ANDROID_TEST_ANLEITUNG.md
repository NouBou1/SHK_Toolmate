...
3. Schau auf die **Console-Logs**, dort siehst du:
   ```
   [OK] StatusBar: overlaysWebView=false gesetzt
   [DEBUG] Android Safe Area: {viewport, screen, statusBar, navBar}
   ```
4. **Visuell prüfen**:
   - [FALSCH] FALSCH: Content ist von Statusleiste überdeckt
   - [OK] RICHTIG: Header sitzt unter der Statusleiste
   - [OK] RICHTIG: Navigation unten ist sichtbar
   - [OK] RICHTIG: Content scrollbar ohne Navigation zu verdecken
...
- **Check**: In app.js konsole_log("[OK] StatusBar: overlaysWebView=false gesetzt")
